...
def update_figures(start_date, end_date, mode, selected_genres, selected_platforms):
    ...
    filtered = agg_games_year_genre_platform.query('year_of_release >= @start_date and year_of_release <= @end_date') # напишите код
    filtered = filtered.query('genre in @selected_genres') 
    filtered = filtered.query('platform in @selected_platforms') 
    
    filtered_score = agg_games_year_score.query('year_of_release >= @start_date and year_of_release <= @end_date') # напишите код
